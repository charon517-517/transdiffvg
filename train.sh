...
# # RefCOCO
python -m  torch.distributed.launch --nproc_per_node=4 --master_port=25641 --use_env train.py --batch_size 4 --lr_bert 0.00001 --aug_crop --aug_scale --aug_translate --backbone resnet50 --detr_model ./checkpoints/detr-r50-unc.pth --bert_enc_num 12 --detr_enc_num 6 --dataset unc --max_query_len 20 --output_dir outputs/refcoco_r50 --data_root /home/wangsai/VPD/refer/refer/data --bert_model /home/wangsai/.cache/bert-base-uncased/bert-base-uncased
# RefCOCO+>& 
