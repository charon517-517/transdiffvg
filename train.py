...
def get_args_parser():
    ...
    # use unet or not
    parser.add_argument('--use_unet', default=1, type=int)
...
def main(args):
    ...
    np.random.seed(seed)
    random.seed(seed)
    print(f"use_unet = {args.use_unet}")
    # build model
    # print("before train.py 141")
    model = build_model(args)
    # print("after train.py 141")
    model = model.to(device)


    # print(model.visumodel.transformer.device)
    # print(model.textmodel.device)
    # print(model.unet.device)
    # print(model.feat_extractor.device)
    ...
    # build dataset
    # print("before load dataset in train.py")
    dataset_train = build_dataset('train', args)
    dataset_val   = build_dataset('val', args)
    # print("after load dataset in train.py")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        t2 = time.time()
        print(f"train_one_epoch cost {t2-t1}s")
        lr_scheduler.step()
